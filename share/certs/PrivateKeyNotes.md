...
unlocked to sign the Blackmore-Qt.app bundle.
...
allowing somebody to distribute a Blackmore-Qt.app or blackmore-qt-setup.exe with a valid
...
that the blackmore-qt.exe file inside the installer had not been tampered with.
