...
The Blackcoin More project has been designed to support multiple localisations. This makes adding new phrases, and completely new languages easily achievable. For managing all application translations, Blackcoin More makes use of the Transifex online translation management tool.
...
See the [Blackcoin More Transifex project](https://app.transifex.com/BlackcoinQT/BlackcoinMore/) to assist in translations.
...
You can find the Blackcoin More translation project at [https://app.transifex.com/BlackcoinQT/BlackcoinMore/](https://app.transifex.com/BlackcoinQT/BlackcoinMore/).
...
The Transifex Blackcoin More project config file is included as part of the repo. It can be found at `.tx/config`, however you shouldn’t need to change anything.
