...
port 55715 for testnet4, port 45715 for signet, and port 35715 for regtest.
...
Risks
-------------
Running a web browser on the same node with a REST enabled blackmored can be a risk. Accessing prepared XSS websites could read out tx/block data of your node by placing links like `<script src="http://127.0.0.1:15715/rest/tx/1234567890.json">` which might break the nodes privacy.
